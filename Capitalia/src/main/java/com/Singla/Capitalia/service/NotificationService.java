    ...
    public void sendDailyIncomeExpenseReminder(){
        ...
        for(ProfileEntity profile : profiles){
            String body = "Hi " + profile.getFullName() + ",<br><br>"
                    + "This is a friendly reminder to add your income and expenses for today in Capitalia.<br>"
                    + "<a href=" + frontendUrl
                    + "style='display:inline-block;padding:10px 20px;background-color:#4CAF50;"
                    + "color:white;text-decoration:none;border-radius:5px;margin-top:10px;'>"
                    + "Open Capitalia</a>"
                    + "<br><br>Best regards,<br>Capitalia Team";
    ...
    public void sendDailyExpenseSummary(){
        ...
        for(ProfileEntity profile : profiles){
            ...
            if(!todayExpenses.isEmpty()){
                ...
                String body = "Hi" + profile.getFullName() + "<br/><br/> Here is a summary of your daily expense : <br/><br/>"+table+"<br/><br/>Best Regards,<br/>Capitalia team";
                emailService.sendMail(profile.getEmail(),"your daily expense service" ,body);
